...
控制器分为两种主要类型：[[CBF-PlayerController玩家角色控制器|PlayerController]]和[[AIController AI角色控制器|AIController]]。PlayerController用于处理玩家输入并控制角色，而AIController则用于控制由人工智能驱动的角色。
