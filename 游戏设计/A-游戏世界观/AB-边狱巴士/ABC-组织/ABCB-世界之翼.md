...
#### 制度
- T公司规定居民必须持有钟表，短期停留的外来人员若提前缴纳等额的时间税，则可不必携带。
- 在T公司管辖范围内，特定空间内时间流动变慢的现象被称为时间泄漏现象，该现象会产生时间累进税（某些情况也会乘算以空间为单位计算的附加税），税金会有T公司的征收人员上门收取，可用金钱或时间缴纳。
- 征收人员在初次访问时需出示钟表表明身份且等待答复五分钟。若此后滞纳者仍无应答行为，可视为逃税罪并强制执行。于征收程序中，只要有正当理由，征收人员被允许在未持有搜查令的情况下进入滞纳者的私有空间。
- 拒绝缴纳或无能力缴纳的人也可能会选择走上时间秤绞刑架，由机器准确测量出应缴纳的时间，并从其身上直接抽取掉。
- 虽然鼓励发明，但在T巢内进行的技术发明需要进行登记批准。没有进行商业注册的五人及以上的私人技术研发小组必须得到T公司的正式批准；任何未经T公司技术局批准的技术也将被没收并处罚。
